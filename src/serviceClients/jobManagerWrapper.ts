...
export class JobManagerWrapper extends JobManagerClient {
  ...
  @withSpanAsyncV4
  public async createInitJob(data: IngestionNewLayer, checksum: string): Promise<ICreateJobResponse> {
...
export type CreateJobBody = ICreateJobBody<IngestionNewJobParams | IngestionUpdateJobParams | IngestionSwapUpdateJobParams, ValidationsTaskParameters>;
